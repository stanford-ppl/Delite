...
numSamples = dims(1);
numTokens = dims(2);
phi_y1 = gpuArray(zeros(numTokens,1)); % size of number of tokens
phi_y0 = gpuArray(zeros(numTokens,1));
num_y1 = gpuArray(zeros(numTokens,1)); 
num_y0 = gpuArray(zeros(numTokens,1));
den_y1 = gpuArray(zeros(numTokens,1));
den_y0 = gpuArray(zeros(numTokens,1));
