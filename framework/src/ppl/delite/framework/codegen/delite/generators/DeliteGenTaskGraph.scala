    ...
    */
    ...
    rhs match {
      ...
      case ThinDef(z) => z match {
        ...
        case _ => emitSingleTask(kernelName, outputs, inputs, inMutating, inControlDeps, antiDeps, optContext) // things that are not specified as DeliteOPs, emit as SingleTask nodes
      }
    }
