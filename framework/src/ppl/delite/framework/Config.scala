...
object Config {
  ...
  val generateGPU = System.getProperty("delite.generation.gpu", "false") != "false"
  val generateC = System.getProperty("delite.generation.c", "false") != "false"
  ...
  val nestedVariantsLevel = System.getProperty("nested.variants.level", "0").toInt
}
