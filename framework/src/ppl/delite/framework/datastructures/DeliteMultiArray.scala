...
trait DeliteMultiArrayOps extends DeliteAbstractOps with RangeVectorOps {  
  ...
  class DeliteMultiArrayOpsCls[T:Manifest](ma: Rep[DeliteMultiArray[T]])(implicit ctx: SourceContext) {
    ...
    // --- Permuting
    // TODO: Move these to their associated ops classes when created
    /*def permute(d0: Int, d1: Int, d2: Int): Rep[DeliteArray3D[T]] = dmultia_permute(ma, Seq(d0, d1, d2)).as3D
    def permute(d0: Int, d1: Int, d2: Int, d3: Int): Rep[DeliteArray4D[T]] = dmultia_permute(ma, Seq(d0, d1, d2, d3)).as4D
    def permute(d0: Int, d1: Int, d2: Int, d3: Int, d4: Int): Rep[DeliteArray5D[T]] = dmultia_permute(ma, Seq(d0, d1, d2, d3, d4)).as5D
    def permute(d0: Int, d1: Int, d2: Int, d3: Int, d4: Int, d5: Int*): Rep[DeliteMultiArray[T]] = dmultia_permute(ma, Seq(d0, d1, d2, d3, d4) ++ d5.toSeq)

    def permuteView(d0: Int, d1: Int, d2: Int): Rep[DeliteArray3D[T]] = fmultia_permute_view(ma, Seq(d0, d1, d2)).as3D
    def permuteView(d0: Int, d1: Int, d2: Int, d3: Int): Rep[DeliteArray4D[T]] = fmultia_permute_view(ma, Seq(d0, d1, d2, d3)).as4D
    def permuteView(d0: Int, d1: Int, d2: Int, d3: Int, d4: Int): Rep[DeliteArray5D[T]] = fmultia_permute_view(ma, Seq(d0, d1, d2, d3, d4)).as5D
    def permuteView(d0: Int, d1: Int, d2: Int, d3: Int, d4: Int, d5: Int*): Rep[DeliteMultiArray[T]] = fmultia_permute_view(ma, Seq(d0, d1, d2, d3, d4) ++ d5.toSeq)*/
  ...
  def dmultia_filterReduce[A:Manifest](ma: Rep[DeliteMultiArray[A]], zero: Rep[DeliteMultiArray[A]], filter: Rep[Int] => Rep[Boolean], reduce: (Rep[DeliteMultiArray[A]], Rep[DeliteMultiArray[A]]) => Rep[DeliteMultiArray[A]], axis: Int)(implicit ctx: SourceContext): Rep[DeliteMultiArray[A]]
...
trait DeliteMultiArrayOpsExp extends DeliteMultiArrayOps with DeliteAbstractOpsExp with RangeVectorOpsExp { this: DeliteOpsExp =>
  ...
  // --- HashMap nodes
  case class DeliteMultiMapSize[K:Manifest,V:Manifest](dm: Exp[DeliteMultiMap[K,V]])(implicit ctx: SourceContext) extends AbstractDefWithManifest2[K,V,Int]
  case class DeliteMultiMapGet[K:Manifest,V:Manifest](dm: Exp[DeliteMultiMap[K,V]], key: Exp[K])(implicit ctx: SourceContext) extends AbstractDefWithManifest2[K,V,V]
  case class DeliteMultiMapContains[K:Manifest,V:Manifest](dm: Exp[DeliteMultiMap[K,V]], key: Exp[K])(implicit ctx: SourceContext) extends AbstractDefWithManifest2[K,V,Boolean]
  case class DeliteMultiMapKeys[K:Manifest,V:Manifest](dm: Exp[DeliteMultiMap[K,V]])(implicit ctx: SourceContext) extends AbstractDefWithManifest2[K,V,DeliteArray1D[K]]
  case class DeliteMultiMapVals[K:Manifest,V:Manifest](dm: Exp[DeliteMultiMap[K,V]])(implicit ctx: SourceContext) extends AbstractDefWithManifest2[K,V,DeliteArray1D[V]]
  case class DeliteMultiMapFromArrays[K:Manifest,V:Manifest](keys: Exp[DeliteArray1D[K]], vals: Exp[DeliteArray1D[V]])(implicit ctx: SourceContext) extends AbstractDefWithManifest2[K,V,DeliteMultiMap[K,V]]
  ...
  case class DeliteMultiArrayPermuteView[A:Manifest](ma: Exp[DeliteMultiArray[A]], config: Seq[Int])(implicit ctx: SourceContext) extends AbstractDefWithManifest[A,DeliteMultiArray[A]]
  case class DeliteMultiArrayReshapeView[A:Manifest](ma: Exp[DeliteMultiArray[A]], dims: Seq[Exp[Int]], UNSAFE: Boolean)(implicit ctx: SourceContext) extends AbstractDefWithManifest[A,DeliteMultiArray[A]]
   ...
   */
  case class DeliteMultiArrayFold[A:Manifest](in: Exp[DeliteMultiArray[A]], func: (Exp[A],Exp[A]) => Exp[A], zero: Exp[A])(implicit ctx: SourceContext) extends DeliteAbstractLoop[A,A] {
   ...
   * @param func  - function on set of indices
   */ 
  case class DeliteMultiArrayForShapeIndices(shape: Seq[Exp[Int]], func: Exp[LoopIndices] => Exp[Unit])(implicit ctx: SourceContext) extends DeliteAbstractLoop[Int,Unit] {
   ...
   */
  case class DeliteMultiArrayGroupBy[A:Manifest,K:Manifest,V:Manifest](in: Exp[DeliteMultiArray[A]], key: Exp[A] => Exp[K], value: Exp[A] => Exp[V])(implicit ctx: SourceContext) extends DeliteAbstractLoop3[A,K,V,DeliteMultiMap[K,DeliteArray1D[V]]] {
   ...
   */
  case class DeliteMultiArrayGroupByReduce[A:Manifest,K:Manifest,V:Manifest](in: Exp[DeliteMultiArray[A]], key: Exp[A] => Exp[K], value: Exp[A] => Exp[V], reduce: (Exp[V],Exp[V]) => Exp[V])(implicit ctx: SourceContext) extends DeliteAbstractLoop3[A,K,V,DeliteMultiMap[K,V]] {
   ...
   * @param axis   - dimension which to reduce along
   */
  case class DeliteMultiArrayFilterReduce[A:Manifest](in: Exp[DeliteMultiArray[A]], zero: Exp[DeliteMultiArray[A]], filter: Exp[Int] => Exp[Boolean], reduce: (Exp[DeliteMultiArray[A]], Exp[DeliteMultiArray[A]]) => Exp[DeliteMultiArray[A]], axis: Int)(implicit ctx: SourceContext) extends DeliteAbstractLoop[A, DeliteMultiArray[A]] {
    type OpType <: DeliteMultiArrayFilterReduce[A]
   ...
   */ 
  case class DeliteMultiArrayMkString[A:Manifest](ma: Exp[DeliteMultiArray[A]], dels: Seq[Exp[String]], func: Option[Exp[A] => Exp[String]])(implicit ctx: SourceContext) extends DeliteAbstractLoop[A,String] {
  ...
  // --- 2D Ops
  case class DeliteMatrixMultiply[A:Manifest](lhs: Exp[DeliteArray2D[A]], rhs: Exp[DeliteArray2D[A]], default: (Exp[DeliteArray2D[A]], Exp[DeliteArray2D[A]]) => Exp[DeliteArray2D[A]])(implicit ctx: SourceContext) extends DeliteAbstractLoop[A,DeliteArray2D[A]] {
  ...
  case class DeliteMatrixVectorMultiply[A:Manifest](mat: Exp[DeliteArray2D[A]], vec: Exp[DeliteArray1D[A]],  default: (Exp[DeliteArray2D[A]], Exp[DeliteArray1D[A]]) => Exp[DeliteArray1D[A]])(implicit ctx: SourceContext) extends DeliteAbstractLoop[A,DeliteArray1D[A]] {
  ...
  def dmultia_filterReduce[A:Manifest](ma: Exp[DeliteMultiArray[A]], zero: Exp[DeliteMultiArray[A]], filter: Exp[Int] => Exp[Boolean], reduce: (Exp[DeliteMultiArray[A]], Exp[DeliteMultiArray[A]]) => Exp[DeliteMultiArray[A]], axis: Int)(implicit ctx: SourceContext) = DeliteMultiArrayFilterReduce(ma,zero,filter,reduce,axis)
  ...
  def isMultiArrayTpe(x: Manifest[_]): Boolean = isSubtype(x.erasure, classOf[DeliteMultiArray[_]])
  ...
  override def blocks(e: Any): List[Block[Any]] = e match {
    ...
    case op: DeliteMultiArrayFilterReduce[_] => blocks(op.filtFunc) ::: blocks(op.redFunc)
  ...
  override def syms(e: Any): List[Sym[Any]] = e match {
    ...
    case op: DeliteMultiArrayFilterReduce[_] => syms(op.filtFunc) ::: syms(op.redFunc) ::: syms(op.in) ::: syms(op.zero)
  ...
  override def readSyms(e: Any): List[Sym[Any]] = e match {
    ...
    case op: DeliteMultiArrayFilterReduce[_] => readSyms(op.filtFunc) ::: readSyms(op.redFunc) ::: readSyms(op.in) ::: readSyms(op.zero)
  ...
  override def symsFreq(e: Any): List[(Sym[Any], Double)] = e match {
    ...
    case op: DeliteMultiArrayFilterReduce[_] => freqHot(op.filtFunc) ::: freqHot(op.redFunc) ::: freqNormal(op.in) ::: freqNormal(op.zero)
 ...
 // symbols which are bound in a definition
  override def boundSyms(e: Any): List[Sym[Any]] = e match {
    ...
    case op: DeliteMultiArrayFilterReduce[_] => List(op.v, op.rV._1, op.rV._2) ::: effectSyms(op.filtFunc) ::: effectSyms(op.redFunc)
  ...
  override def aliasSyms(e: Any): List[Sym[Any]] = e match {
    ...
    case op: DeliteMultiArrayFilterReduce[_] => Nil
  ...
  override def mirror[A:Manifest](e: Def[A], f: Transformer)(implicit ctx: SourceContext): Exp[A] = (e match {
    ...
    case e@DeliteMultiArrayFold(m,g,z) =>
      e.asInstanceOf[DeliteMultiArrayFold[A]] match {
        case e@DeliteMultiArrayFold(m,g,z) =>
          reflectPure(new { override val original = Some(f,e) } with DeliteMultiArrayFold(f(m),g,f(z))(e.mA,ctx))(mtype(manifest[A]),ctx)
      }
    ...
    case e@DeliteMultiArrayGroupBy(m,k,v) => reflectPure(new { override val original = Some(f,e) } with DeliteMultiArrayGroupBy(f(m),k,v)(e.mA,e.mB,e.mT,ctx))(mtype(manifest[A]), ctx)
    ...
    case e@DeliteMultiArrayFilterReduce(m,z,g,r,a) => reflectPure(new {override val original = Some(f,e) } with DeliteMultiArrayFilterReduce(f(m),f(z),g,r,a)(e.mA,ctx))(mtype(manifest[A]),ctx)
    ...
    case Reflect(e@DeliteMultiArrayFold(m,g,z), u, es) =>
      e.asInstanceOf[DeliteMultiArrayFold[A]] match {
        case e@DeliteMultiArrayFold(m,g,z) =>
          reflectMirrored(Reflect(new { override val original = Some(f,e) } with DeliteMultiArrayFold(f(m),g,f(z))(e.mA,ctx), mapOver(f,u), f(es)))(mtype(manifest[A]),ctx)
      }
    ...
    case Reflect(e@DeliteMultiArrayGroupBy(m,k,v), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with DeliteMultiArrayGroupBy(f(m),k,v)(e.mA,e.mB,e.mT,ctx), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)        
    ...
    case Reflect(e@DeliteMultiArrayFilterReduce(m,z,g,r,a), u, es) => reflectMirrored(Reflect(new {override val original = Some(f,e) } with DeliteMultiArrayFilterReduce(f(m),f(z),g,r,a)(e.mA,ctx), mapOver(f,u), f(es)))(mtype(manifest[A]),ctx)
