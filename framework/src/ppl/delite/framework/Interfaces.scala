...
trait InterfacesExp extends Interfaces with BaseExp with Effects with Blocks with OverloadHack {
  ...
  override def aliasSyms(e: Any): List[Sym[Any]] = e match {
    case i: Interface[_] => aliasSyms(i.ops.elem)
    case _ => super.aliasSyms(e)
  }  

  override def containSyms(e: Any): List[Sym[Any]] = e match {
    case i: Interface[_] => containSyms(i.ops.elem)
    case _ => super.containSyms(e)    
  }

  override def extractSyms(e: Any): List[Sym[Any]] = e match {
    case i: Interface[_] => extractSyms(i.ops.elem)
    case _ => super.extractSyms(e)   
  }

  override def copySyms(e: Any): List[Sym[Any]] = e match {
    case i: Interface[_] => copySyms(i.ops.elem)
