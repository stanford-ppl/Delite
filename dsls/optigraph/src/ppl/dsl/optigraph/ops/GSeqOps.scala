...
trait GSeqOpsExp extends GSeqOps with VariablesExp with BaseFatExp {
  ...
  override def mirror[A:Manifest](e: Def[A], f: Transformer)(implicit ctx: SourceContext): Exp[A] = (e match {
    ...
    case Reflect(e@GSeqObjectNew(), u, es) => reflectMirrored(Reflect(GSeqObjectNew()(e.mGS), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GSeqItems(o), u, es) => reflectMirrored(Reflect(GSeqItems(f(o)), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GSeqContains(o,x), u, es) => reflectMirrored(Reflect(GSeqContains(f(o),f(x)), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GSeqSize(o), u, es) => reflectMirrored(Reflect(GSeqSize(f(o)), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GSeqFront(o), u, es) => reflectMirrored(Reflect(GSeqFront(f(o))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GSeqBack(o), u, es) => reflectMirrored(Reflect(GSeqBack(f(o))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GSeqApply(o,n), u, es) => reflectMirrored(Reflect(GSeqApply(f(o),f(n))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GSeqPushFront(o,x), u, es) => reflectMirrored(Reflect(GSeqPushFront(f(o),f(x)), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GSeqPushBack(o,x), u, es) => reflectMirrored(Reflect(GSeqPushBack(f(o),f(x)), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GSeqPushFrontSeq(o,x), u, es) => reflectMirrored(Reflect(GSeqPushFrontSeq(f(o),f(x)), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GSeqPushBackSeq(o,x), u, es) => reflectMirrored(Reflect(GSeqPushBackSeq(f(o),f(x)), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GSeqPopFront(o), u, es) => reflectMirrored(Reflect(GSeqPopFront(f(o))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GSeqPopBack(o), u, es) => reflectMirrored(Reflect(GSeqPopBack(f(o))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
