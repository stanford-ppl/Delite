...
trait GOrderOpsExp extends GOrderOps with VariablesExp with BaseFatExp {
  ...
  override def mirror[A:Manifest](e: Def[A], f: Transformer)(implicit ctx: SourceContext): Exp[A] = (e match {
    ...
    case Reflect(e@GOrderObjectNew(), u, es) => reflectMirrored(Reflect(GOrderObjectNew()(e.mGO), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GOrderItems(o), u, es) => reflectMirrored(Reflect(GOrderItems(f(o)), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GOrderContains(o,x), u, es) => reflectMirrored(Reflect(GOrderContains(f(o),f(x)), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GOrderSize(o), u, es) => reflectMirrored(Reflect(GOrderSize(f(o)), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GOrderFront(o), u, es) => reflectMirrored(Reflect(GOrderFront(f(o))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GOrderBack(o), u, es) => reflectMirrored(Reflect(GOrderBack(f(o))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GOrderApply(o,n), u, es) => reflectMirrored(Reflect(GOrderApply(f(o),f(n))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GOrderPushFront(o,x), u, es) => reflectMirrored(Reflect(GOrderPushFront(f(o),f(x)), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GOrderPushBack(o,x), u, es) => reflectMirrored(Reflect(GOrderPushBack(f(o),f(x)), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GOrderPushFrontOrd(o,x), u, es) => reflectMirrored(Reflect(GOrderPushFrontOrd(f(o),f(x)), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GOrderPushBackOrd(o,x), u, es) => reflectMirrored(Reflect(GOrderPushBackOrd(f(o),f(x)), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GOrderPopFront(o), u, es) => reflectMirrored(Reflect(GOrderPopFront(f(o))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@GOrderPopBack(o), u, es) => reflectMirrored(Reflect(GOrderPopBack(f(o))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
