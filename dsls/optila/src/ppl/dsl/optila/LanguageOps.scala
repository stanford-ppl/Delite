...
trait LanguageOpsExp extends LanguageOps with BaseFatExp with EffectExp {
  ...
  override def mirror[A:Manifest](e: Def[A], f: Transformer)(implicit ctx: SourceContext): Exp[A] = (e match {
    ...
    case Reflect(e@VectorDistanceAbs(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorDistanceAbs(f(x),f(y))(e.m,e.a), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(RandReseed(), u, es) => reflectMirrored(Reflect(RandReseed(), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(RandInt(), u, es) => reflectMirrored(Reflect(RandInt(), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(RandDouble(), u, es) => reflectMirrored(Reflect(RandDouble(), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(RandGaussian(), u, es) => reflectMirrored(Reflect(RandGaussian(), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(RandFloat(), u, es) => reflectMirrored(Reflect(RandFloat(), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(RandIntMax(max), u, es) => reflectMirrored(Reflect(RandIntMax(f(max)), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@RandElem(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with RandElem(f(x))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixDeterminant(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixDeterminant(f(x))(e.m,e.a,e.n), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(ProfileStart(c,deps), u, es) => reflectMirrored(Reflect(ProfileStart(f(c),f(deps)), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(ProfileStop(c,deps), u, es) => reflectMirrored(Reflect(ProfileStop(f(c),f(deps)), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(ProfileTime(deps), u, es) => reflectMirrored(Reflect(ProfileTime(f(deps)), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
