...
trait DenseVectorOps extends Variables {
  ...
  // generic addition
  def infix_+[L,R:Arith:Manifest](lhs: L, rhs: Rep[DenseVector[R]])(implicit c: L => Rep[R], ctx: SourceContext, o: Overloaded1): Rep[DenseVector[R]] = vector_plus_scalar[R,DenseVector[R]](denseToInterface(rhs),c(lhs))
  def infix_+[L:Arith:Manifest,R:Arith:Manifest](lhs: Rep[L], rhs: Rep[DenseVector[R]])(implicit c: Rep[R] => Rep[L], ctx: SourceContext, o: Overloaded2): Rep[DenseVector[L]] = vector_plus_scalar_withconvert[R,L,DenseVector[L]](denseToInterface(rhs),lhs)
  def infix_+[L:Arith:Manifest,R:Arith:Manifest](lhs: Rep[DenseVector[L]], rhs: Rep[R])(implicit c: Rep[L] => Rep[R], ctx: SourceContext, o: Overloaded3): Rep[DenseVector[R]] = vector_plus_scalar_withconvert[L,R,DenseVector[R]](denseToInterface(lhs),rhs)
  def infix_+[L:Arith:Manifest,R:Arith:Manifest](lhs: Rep[DenseVector[L]], rhs: R)(implicit c: Rep[L] => Rep[R], ctx: SourceContext, o: Overloaded4): Rep[DenseVector[R]] = vector_plus_scalar_withconvert[L,R,DenseVector[R]](denseToInterface(lhs),unit(rhs))
  def infix_+[L:Arith:Manifest,R:Arith:Manifest](lhs: Rep[DenseVector[L]], rhs: Rep[DenseVector[R]])(implicit c: Rep[L] => Rep[R], ctx: SourceContext, o: Overloaded13): Rep[DenseVector[R]] = vector_plus_withconvert[L,R,DenseVector[R]](denseToInterface(lhs),denseToInterface(rhs))
  
  // special cases to fill in the holes
  def infix_+(lhs: Rep[Int], rhs: Rep[DenseVector[Double]])(implicit ctx: SourceContext, o: Overloaded5): Rep[DenseVector[Double]] = vector_plus_scalar[Double,DenseVector[Double]](denseToInterface(rhs),repIntToRepDouble(lhs))
  def infix_+(lhs: Rep[Int], rhs: Rep[DenseVector[Float]])(implicit ctx: SourceContext, o: Overloaded6): Rep[DenseVector[Float]] = vector_plus_scalar[Float,DenseVector[Float]](denseToInterface(rhs),repIntToRepFloat(lhs))
  def infix_+(lhs: Rep[Float], rhs: Rep[DenseVector[Double]])(implicit ctx: SourceContext, o: Overloaded7): Rep[DenseVector[Double]] = vector_plus_scalar[Double,DenseVector[Double]](denseToInterface(rhs),repFloatToRepDouble(lhs))
  def infix_+(lhs: Int, rhs: Rep[DenseVector[Int]])(implicit ctx: SourceContext, o: Overloaded8): Rep[DenseVector[Int]] = repToDenseVecOps(rhs).+(unit(lhs))
  def infix_+(lhs: Float, rhs: Rep[DenseVector[Float]])(implicit ctx: SourceContext, o: Overloaded9): Rep[DenseVector[Float]] = repToDenseVecOps(rhs).+(unit(lhs))
  def infix_+(lhs: Float, rhs: Rep[DenseVector[Int]])(implicit ctx: SourceContext, o: Overloaded10): Rep[DenseVector[Float]] = vector_plus_scalar_withconvert[Int,Float,DenseVector[Float]](denseToInterface(rhs),unit(lhs))
  def infix_+(lhs: Double, rhs: Rep[DenseVector[Int]])(implicit ctx: SourceContext, o: Overloaded11): Rep[DenseVector[Double]] = vector_plus_scalar_withconvert[Int,Double,DenseVector[Double]](denseToInterface(rhs),unit(lhs))
  def infix_+(lhs: Double, rhs: Rep[DenseVector[Float]])(implicit ctx: SourceContext, o: Overloaded12): Rep[DenseVector[Double]] = vector_plus_scalar_withconvert[Float,Double,DenseVector[Double]](denseToInterface(rhs),unit(lhs))

  def infix_-[L,R:Arith:Manifest](lhs: L, rhs: Rep[DenseVector[R]])(implicit c: L => Rep[R], ctx: SourceContext, o: Overloaded1): Rep[DenseVector[R]] = vector_minus_scalar[R,DenseVector[R]](denseToInterface(rhs),c(lhs))
  def infix_-[L:Arith:Manifest,R:Arith:Manifest](lhs: Rep[L], rhs: Rep[DenseVector[R]])(implicit c: Rep[R] => Rep[L], ctx: SourceContext, o: Overloaded2): Rep[DenseVector[L]] = vector_minus_scalar_withconvert[R,L,DenseVector[L]](denseToInterface(rhs),lhs)
  def infix_-[L:Arith:Manifest,R:Arith:Manifest](lhs: Rep[DenseVector[L]], rhs: Rep[R])(implicit c: Rep[L] => Rep[R], ctx: SourceContext, o: Overloaded3): Rep[DenseVector[R]] = vector_minus_scalar_withconvert[L,R,DenseVector[R]](denseToInterface(lhs),rhs)
  def infix_-[L:Arith:Manifest,R:Arith:Manifest](lhs: Rep[DenseVector[L]], rhs: R)(implicit c: Rep[L] => Rep[R], ctx: SourceContext, o: Overloaded4): Rep[DenseVector[R]] = vector_minus_scalar_withconvert[L,R,DenseVector[R]](denseToInterface(lhs),unit(rhs))
  def infix_-[L:Arith:Manifest,R:Arith:Manifest](lhs: Rep[DenseVector[L]], rhs: Rep[DenseVector[R]])(implicit c: Rep[L] => Rep[R], ctx: SourceContext, o: Overloaded13): Rep[DenseVector[R]] = vector_minus_withconvert[L,R,DenseVector[R]](denseToInterface(lhs),denseToInterface(rhs))
  def infix_-(lhs: Rep[Int], rhs: Rep[DenseVector[Double]])(implicit ctx: SourceContext, o: Overloaded5): Rep[DenseVector[Double]] = vector_minus_scalar[Double,DenseVector[Double]](denseToInterface(rhs),repIntToRepDouble(lhs))
  def infix_-(lhs: Rep[Int], rhs: Rep[DenseVector[Float]])(implicit ctx: SourceContext, o: Overloaded6): Rep[DenseVector[Float]] = vector_minus_scalar[Float,DenseVector[Float]](denseToInterface(rhs),repIntToRepFloat(lhs))
  def infix_-(lhs: Rep[Float], rhs: Rep[DenseVector[Double]])(implicit ctx: SourceContext, o: Overloaded7): Rep[DenseVector[Double]] = vector_minus_scalar[Double,DenseVector[Double]](denseToInterface(rhs),repFloatToRepDouble(lhs))
  def infix_-(lhs: Int, rhs: Rep[DenseVector[Int]])(implicit ctx: SourceContext, o: Overloaded8): Rep[DenseVector[Int]] = repToDenseVecOps(rhs).-(unit(lhs))
  def infix_-(lhs: Float, rhs: Rep[DenseVector[Float]])(implicit ctx: SourceContext, o: Overloaded9): Rep[DenseVector[Float]] = repToDenseVecOps(rhs).-(unit(lhs))
  def infix_-(lhs: Float, rhs: Rep[DenseVector[Int]])(implicit ctx: SourceContext, o: Overloaded10): Rep[DenseVector[Float]] = vector_minus_scalar_withconvert[Int,Float,DenseVector[Float]](denseToInterface(rhs),unit(lhs))
  def infix_-(lhs: Double, rhs: Rep[DenseVector[Int]])(implicit ctx: SourceContext, o: Overloaded11): Rep[DenseVector[Double]] = vector_minus_scalar_withconvert[Int,Double,DenseVector[Double]](denseToInterface(rhs),unit(lhs))
  def infix_-(lhs: Double, rhs: Rep[DenseVector[Float]])(implicit ctx: SourceContext, o: Overloaded12): Rep[DenseVector[Double]] = vector_minus_scalar_withconvert[Float,Double,DenseVector[Double]](denseToInterface(rhs),unit(lhs))
  
  def infix_*[L,R:Arith:Manifest](lhs: L, rhs: Rep[DenseVector[R]])(implicit c: L => Rep[R], ctx: SourceContext, o: Overloaded1): Rep[DenseVector[R]] = vector_times_scalar[R,DenseVector[R]](denseToInterface(rhs),c(lhs))
  def infix_*[L:Arith:Manifest,R:Arith:Manifest](lhs: Rep[L], rhs: Rep[DenseVector[R]])(implicit c: Rep[R] => Rep[L], ctx: SourceContext, o: Overloaded2): Rep[DenseVector[L]] = vector_times_scalar_withconvert[R,L,DenseVector[L]](denseToInterface(rhs),lhs)
  def infix_*[L:Arith:Manifest,R:Arith:Manifest](lhs: Rep[DenseVector[L]], rhs: Rep[R])(implicit c: Rep[L] => Rep[R], ctx: SourceContext, o: Overloaded3): Rep[DenseVector[R]] = vector_times_scalar_withconvert[L,R,DenseVector[R]](denseToInterface(lhs),rhs)
  def infix_*[L:Arith:Manifest,R:Arith:Manifest](lhs: Rep[DenseVector[L]], rhs: R)(implicit c: Rep[L] => Rep[R], ctx: SourceContext, o: Overloaded4): Rep[DenseVector[R]] = vector_times_scalar_withconvert[L,R,DenseVector[R]](denseToInterface(lhs),unit(rhs))
  def infix_*[L:Arith:Manifest,R:Arith:Manifest](lhs: Rep[DenseVector[L]], rhs: Rep[DenseVector[R]])(implicit c: Rep[L] => Rep[R], ctx: SourceContext, o: Overloaded13): Rep[DenseVector[R]] = vector_times_withconvert[L,R,DenseVector[R]](denseToInterface(lhs),denseToInterface(rhs))
  def infix_*(lhs: Rep[Int], rhs: Rep[DenseVector[Double]])(implicit ctx: SourceContext, o: Overloaded5): Rep[DenseVector[Double]] = vector_times_scalar[Double,DenseVector[Double]](denseToInterface(rhs),repIntToRepDouble(lhs))
  def infix_*(lhs: Rep[Int], rhs: Rep[DenseVector[Float]])(implicit ctx: SourceContext, o: Overloaded6): Rep[DenseVector[Float]] = vector_times_scalar[Float,DenseVector[Float]](denseToInterface(rhs),repIntToRepFloat(lhs))
  def infix_*(lhs: Rep[Float], rhs: Rep[DenseVector[Double]])(implicit ctx: SourceContext, o: Overloaded7): Rep[DenseVector[Double]] = vector_times_scalar[Double,DenseVector[Double]](denseToInterface(rhs),repFloatToRepDouble(lhs))
  def infix_*(lhs: Int, rhs: Rep[DenseVector[Int]])(implicit ctx: SourceContext, o: Overloaded8): Rep[DenseVector[Int]] = repToDenseVecOps(rhs).*(unit(lhs))
  def infix_*(lhs: Float, rhs: Rep[DenseVector[Float]])(implicit ctx: SourceContext, o: Overloaded9): Rep[DenseVector[Float]] = repToDenseVecOps(rhs).*(unit(lhs))
  def infix_*(lhs: Float, rhs: Rep[DenseVector[Int]])(implicit ctx: SourceContext, o: Overloaded10): Rep[DenseVector[Float]] = vector_times_scalar_withconvert[Int,Float,DenseVector[Float]](denseToInterface(rhs),unit(lhs))
  def infix_*(lhs: Double, rhs: Rep[DenseVector[Int]])(implicit ctx: SourceContext, o: Overloaded11): Rep[DenseVector[Double]] = vector_times_scalar_withconvert[Int,Double,DenseVector[Double]](denseToInterface(rhs),unit(lhs))
  def infix_*(lhs: Double, rhs: Rep[DenseVector[Float]])(implicit ctx: SourceContext, o: Overloaded12): Rep[DenseVector[Double]] = vector_times_scalar_withconvert[Float,Double,DenseVector[Double]](denseToInterface(rhs),unit(lhs))
  
  def infix_/[L:Arith:Manifest,R:Arith:Manifest](lhs: Rep[DenseVector[L]], rhs: Rep[R])(implicit c: Rep[L] => Rep[R], ctx: SourceContext, o: Overloaded3): Rep[DenseVector[R]] = vector_divide_scalar_withconvert[L,R,DenseVector[R]](denseToInterface(lhs),rhs)
  def infix_/[L:Arith:Manifest,R:Arith:Manifest](lhs: Rep[DenseVector[L]], rhs: R)(implicit c: Rep[L] => Rep[R], ctx: SourceContext, o: Overloaded4): Rep[DenseVector[R]] = vector_divide_scalar_withconvert[L,R,DenseVector[R]](denseToInterface(lhs),unit(rhs))
  def infix_/[L:Arith:Manifest,R:Arith:Manifest](lhs: Rep[DenseVector[L]], rhs: Rep[DenseVector[R]])(implicit c: Rep[L] => Rep[R], ctx: SourceContext, o: Overloaded13): Rep[DenseVector[R]] = vector_divide_withconvert[L,R,DenseVector[R]](denseToInterface(lhs),denseToInterface(rhs))
