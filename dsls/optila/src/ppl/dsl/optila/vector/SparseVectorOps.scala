...
trait SparseVectorOpsExp extends SparseVectorOps with DeliteCollectionOpsExp with SparseTransform {
  ...
  override def mirror[A:Manifest](e: Def[A], f: Transformer)(implicit ctx: SourceContext): Exp[A] = (e match {
    ...
    // read/write effects
    case Reflect(e@SparseVectorNew(l,r), u, es) => reflectMirrored(Reflect(SparseVectorNew(f(l),f(r))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)    
    case Reflect(e@SparseVectorSetLength(x,v), u, es) => reflectMirrored(Reflect(SparseVectorSetLength(f(x),f(v))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)    
    case Reflect(e@SparseVectorSetIsRow(x,v), u, es) => reflectMirrored(Reflect(SparseVectorSetIsRow(f(x),f(v))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)  
    case Reflect(e@SparseVectorSetRawData(x,v), u, es) => reflectMirrored(Reflect(SparseVectorSetRawData(f(x),f(v))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)              
    case Reflect(e@SparseVectorSetRawIndices(x,v), u, es) => reflectMirrored(Reflect(SparseVectorSetRawIndices(f(x),f(v))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)              
    case Reflect(e@SparseVectorSetNnz(x,v), u, es) => reflectMirrored(Reflect(SparseVectorSetNnz(f(x),f(v))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)    
    case Reflect(e@SparseVectorLength(x), u, es) => reflectMirrored(Reflect(SparseVectorLength(f(x))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@SparseVectorIsRow(x), u, es) => reflectMirrored(Reflect(SparseVectorIsRow(f(x))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)    
    case Reflect(e@SparseVectorRawData(x), u, es) => reflectMirrored(Reflect(SparseVectorRawData(f(x))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@SparseVectorRawIndices(x), u, es) => reflectMirrored(Reflect(SparseVectorRawIndices(f(x))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@SparseVectorNnz(x), u, es) => reflectMirrored(Reflect(SparseVectorNnz(f(x))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@SparseVectorApply(x,n), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with SparseVectorApply(f(x),f(n))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@SparseVectorUpdate(x,n,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with SparseVectorUpdate(f(x),f(n),f(y))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@SparseVectorSort(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with SparseVectorSort(f(x))(e.mA,e.o), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@SparseVectorTimesMatrix(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with SparseVectorTimesMatrix(f(x),f(y))(e.mA,e.a), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@SparseVectorTrans(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with SparseVectorTrans(f(x))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@SparseVectorCopyFrom(x,pos,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with SparseVectorCopyFrom(f(x),f(pos),f(y))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@SparseVectorAppend(x,pos,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with SparseVectorAppend(f(x),f(pos),f(y))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@SparseVectorInsert(x,pos,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with SparseVectorInsert(f(x),f(pos),f(y))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@SparseVectorInsertAll(x,pos,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with SparseVectorInsertAll(f(x),f(pos),f(y))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@SparseVectorRemoveAll(x,pos,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with SparseVectorRemoveAll(f(x),f(pos),f(y))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@SparseVectorTrim(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with SparseVectorTrim(f(x))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@SparseVectorClear(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with SparseVectorClear(f(x))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@SparseVectorMutableTrans(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with SparseVectorMutableTrans(f(x))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)    
