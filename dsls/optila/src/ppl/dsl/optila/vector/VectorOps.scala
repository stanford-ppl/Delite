...
trait VectorOpsExp extends VectorOps with DeliteCollectionOpsExp {
  ...
  */
  ...
  override def mirror[A:Manifest](e: Def[A], f: Transformer)(implicit ctx: SourceContext): Exp[A] = (e match {
    ...
    // reflected
    case Reflect(e@VectorEquals(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorEquals(f(x),f(y))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorSlice(x,start,end), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorSlice(f(x),f(start),f(end))(e.mA, e.mR, e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorContains(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorContains(f(x),f(y))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorDistinct(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorDistinct(f(x))(e.mA, e.mR, e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorClone(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorClone(f(x))(e.mA, e.mVA, e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    ...
    case Reflect(e@VectorRepmat(x,i,j), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorRepmat(f(x),f(i),f(j))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorMkString(x,sep), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorMkString(f(x),f(sep))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorConcatenate(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorConcatenate(f(x),f(y))(e.mA, e.mR, e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorMedian(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorMedian(f(x))(e.mA, e.o), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorOuter(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorOuter(f(x),f(y))(e.mA, e.a), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    ...
    case Reflect(e@VectorPlus(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorPlus(f(x),f(y))(e.mA, e.a, e.mVA, e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorPlusWithConvert(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorPlusWithConvert(f(x),f(y))(e.mA, e.mB, e.a, e.mVB, e.conv, e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorPlusScalar(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorPlusScalar(f(x),f(y))(e.mA, e.a, e.mVA, e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorPlusScalarWithConvert(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorPlusScalarWithConvert(f(x),f(y))(e.mA, e.mB, e.a, e.mVB, e.conv, e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorPlusEquals(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorPlusEquals(f(x),f(y))(e.mA, e.a), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorPlusEqualsScalar(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorPlusEqualsScalar(f(x),f(y))(e.mA, e.a), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorMinus(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorMinus(f(x),f(y))(e.mA, e.a, e.mVA, e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorMinusWithConvert(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorMinusWithConvert(f(x),f(y))(e.mA, e.mB, e.a, e.mVB, e.conv, e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorMinusScalar(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorMinusScalar(f(x),f(y))(e.mA, e.a, e.mVA, e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorMinusScalarWithConvert(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorMinusScalarWithConvert(f(x),f(y))(e.mA, e.mB, e.a, e.mVB, e.conv, e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorMinusEquals(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorMinusEquals(f(x),f(y))(e.mA, e.a), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorMinusEqualsScalar(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorMinusEqualsScalar(f(x),f(y))(e.mA, e.a), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorTimes(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorTimes(f(x),f(y))(e.mA, e.a, e.mVA, e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorTimesWithConvert(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorTimesWithConvert(f(x),f(y))(e.mA, e.mB, e.a, e.mVB, e.conv, e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorTimesScalar(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorTimesScalar(f(x),f(y))(e.mA, e.a, e.mVA, e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorTimesScalarWithConvert(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorTimesScalarWithConvert(f(x),f(y))(e.mA, e.mB, e.a, e.mVB, e.conv, e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorTimesEquals(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorTimesEquals(f(x),f(y))(e.mA, e.a), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorTimesEqualsScalar(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorTimesEqualsScalar(f(x),f(y))(e.mA, e.a), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorDotProduct(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorDotProduct(f(x),f(y))(e.mA, e.a), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorDivide(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorDivide(f(x),f(y))(e.mA, e.a, e.mVA, e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorDivideWithConvert(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorDivideWithConvert(f(x),f(y))(e.mA, e.mB, e.a, e.mVB, e.conv, e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorDivideScalar(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorDivideScalar(f(x),f(y))(e.mA, e.a, e.mVA, e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorDivideScalarWithConvert(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorDivideScalarWithConvert(f(x),f(y))(e.mA, e.mB, e.a, e.mVB, e.conv, e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorDivideEquals(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorDivideEquals(f(x),f(y))(e.mA, e.a), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorDivideEqualsScalar(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorDivideEqualsScalar(f(x),f(y))(e.mA, e.a), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorSum(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorSum(f(x))(e.mA, e.a), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorAbs(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorAbs(f(x))(e.mA, e.a, e.mVA, e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorExp(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorExp(f(x))(e.mA, e.a, e.mVA, e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)    
    case Reflect(e@VectorMin(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorMin(f(x))(e.mA, e.o, e.p), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)    
    case Reflect(e@VectorMax(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorMax(f(x))(e.mA, e.o, e.p), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)    
    case Reflect(e@VectorMinIndex(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorMinIndex(f(x))(e.mA, e.o, e.p), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)    
    case Reflect(e@VectorMaxIndex(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorMaxIndex(f(x))(e.mA, e.o, e.p), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)    
    case Reflect(e@VectorMap(a,p), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorMap(f(a),f(p))(e.mA,e.mB,e.mVB,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorForeach(a,b), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorForeach(f(a),f(b)), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorZipWith(x,y,func), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorZipWith(f(x),f(y),f(func))(e.mA,e.mB,e.mR,e.mVR,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorReduce(x,func), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorReduce(f(x),f(func))(e.mA,e.a), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorFilter(x,p), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorFilter(f(x),f(p))(e.mA,e.mVA,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorFind(x,p), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorFind(f(x),f(p))(e.mA,e.mVA,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorCount(x,p), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorCount(f(x),f(p))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorPartition(x,pred), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorPartition(f(x),f(pred))(e.mA,e.mVA,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorGroupBy(x,pred), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorGroupBy(f(x),f(pred))(e.mA,e.mK,e.mVA,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorFlatMap(x,m), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorFlatMap(f(x),f(m))(e.mA,e.mB,mtype(e.mVB),e.b.asInstanceOf[VectorBuilder[Any,A]]), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorMutableMap(x,g), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorMutableMap(f(x),f(g))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorMutableZipWith(x,y,func), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorMutableZipWith(f(x),f(y),f(func))(e.mA,e.mB), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@VectorPPrint(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with VectorPPrint(f(x))(f(e.b)), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)

    // allocations
    case Reflect(e@VectorObjectRange(s,o,d,r), u, es) => reflectMirrored(Reflect(VectorObjectRange(f(s),f(o),f(d),f(r)), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
