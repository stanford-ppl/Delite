...
trait MatrixOps extends Variables {
  ...
  trait MatOpsCls[A] extends DCInterfaceOps[Matrix[A],A] {    
    ...
    type MA <: Matrix[A]
    type IA <: MatrixBuildable[A] 
    type VA = V[A]    
    
    implicit def mA: Manifest[A]    
    implicit def mM[B:Manifest]: Manifest[M[B]] 
    implicit def mMA: Manifest[MA]     
    implicit def mI[B:Manifest]: Manifest[I[B]] 
    implicit def mIA: Manifest[IA]
    implicit def maToOps(x: Rep[MA]): MatOpsCls[A]
    implicit def maToIntf(x: Rep[MA]): Interface[Matrix[A]]
    implicit def maBuilder: MatrixBuilder[A,IA,MA]    
    ...
    def groupRowsBy[K:Manifest](pred: Interface[Vector[A]] => Rep[K])(implicit ctx: SourceContext): Rep[DenseVector[MA]] = matrix_grouprowsby[A,K,IA,MA](x, pred)
  ...
  class InterfaceMatOpsCls[A:Manifest](val intf: MInterface[A]) {
    ...
    def slice(startRow: Rep[Int], endRow: Rep[Int], startCol: Rep[Int], endCol: Rep[Int])(implicit ctx: SourceContext) = intf.ops.maToIntf(intf.ops.slice(startRow,endRow,startCol,endCol))
    def sliceRows(start: Rep[Int], end: Rep[Int])(implicit ctx: SourceContext) = intf.ops.maToIntf(intf.ops.sliceRows(start,end))
    def numRows(implicit ctx: SourceContext) = intf.ops.numRows
    def numCols(implicit ctx: SourceContext) = intf.ops.numCols

    def t(implicit ctx: SourceContext) = intf.ops.maToIntf(intf.ops.t)
    def Clone()(implicit ctx: SourceContext) = intf.ops.maToIntf(intf.ops.Clone())
    def mutable()(implicit ctx: SourceContext) = intf.ops.maToIntf(intf.ops.mutable())
    def pprint()(implicit ctx: SourceContext) = intf.ops.pprint()
    def replicate(i: Rep[Int], j: Rep[Int])(implicit ctx: SourceContext) = intf.ops.maToIntf(intf.ops.replicate(i,j))
    def <<(y: Interface[Vector[A]])(implicit ctx: SourceContext) = intf.ops.maToIntf(intf.ops.<<(y))
    
    def +(y: Interface[Matrix[A]])(implicit a: Arith[A], ctx: SourceContext) = intf.ops.maToIntf(intf.ops.+(y))    
    def +(y: Rep[A])(implicit a: Arith[A], ctx: SourceContext) = intf.ops.maToIntf(intf.ops.+(y))    
    def -(y: Interface[Matrix[A]])(implicit a: Arith[A], ctx: SourceContext) = intf.ops.maToIntf(intf.ops.-(y))    
    def -(y: Rep[A])(implicit a: Arith[A], ctx: SourceContext) = intf.ops.maToIntf(intf.ops.-(y))    
    def *:*(y: Interface[Matrix[A]])(implicit a: Arith[A], ctx: SourceContext) = intf.ops.maToIntf(intf.ops.*:*(y))    
    def *(y: Interface[Matrix[A]])(implicit a: Arith[A], ctx: SourceContext) = intf.ops.maToIntf(intf.ops.*(y))
    ...
    def /(y: Rep[A])(implicit a: Arith[A], ctx: SourceContext) = intf.ops.maToIntf(intf.ops./(y))
    //def unary_-(implicit a: Arith[A]) = matrix_unary_minus(x)
    def abs(implicit a: Arith[A], ctx: SourceContext) = intf.ops.maToIntf(intf.ops.abs)
    def exp(implicit a: Arith[A], ctx: SourceContext) = intf.ops.maToIntf(intf.ops.exp)
    ...
    def filterRows(pred: Interface[Vector[A]] => Rep[Boolean])(implicit ctx: SourceContext) = intf.ops.maToIntf(intf.ops.filterRows(pred))
...
*/
  ...
  override def mirror[A:Manifest](e: Def[A], f: Transformer)(implicit ctx: SourceContext): Exp[A] = (e match {
    ...
    case Reflect(e@MatrixSlice(x,sr,er,sc,ec), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixSlice(f(x),f(sr),f(er),f(sc),f(ec))(e.mA,e.mB,e.mR,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixSliceRows(x,s,end), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixSliceRows(f(x),f(s),f(end))(e.mA,e.mB,e.mR,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixAddRow(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixAddRow(f(x),f(y))(e.mA,e.mB,e.mR,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixClone(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixClone(f(x))(e.mA,e.mB,e.mR,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixEquals(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixEquals(f(x),f(y))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixTranspose(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixTranspose(f(x))(e.mA,e.mI,e.mMA,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixRepmat(x,i,j), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixRepmat(f(x),f(i),f(j))(e.mA,e.mB,e.mR,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixMinRow(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixMinRow(f(x))(e.mA,e.o,e.p,e.mR,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixMaxRow(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixMaxRow(f(x))(e.mA,e.o,e.p,e.mR,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixFilterRows(x,pred), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixFilterRows(f(x),f(pred))(e.mA,e.mB,e.mR,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixSumCol(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixSumCol(f(x))(e.mA,e.a,e.mVA,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixGroupRowsBy(x,pred), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixGroupRowsBy(f(x),f(pred))(e.mA,e.mK,e.mI,e.mMA,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixTimesVector(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixTimesVector(f(x),f(y))(e.mA,e.a,e.mR,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixMultiply(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixMultiply(f(x),f(y))(e.mA,e.a,e.mB,e.mR,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)         
    case Reflect(e@MatrixSigmoid(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixSigmoid(f(x))(e.mA,e.mB,e.mR,e.conv,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixSigmoidF(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixSigmoidF(f(x))(e.mA,e.mB,e.mR,e.conv,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixPlusEquals(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixPlusEquals(f(x),f(y))(e.mA, e.a), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixPlus(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixPlus(f(x),f(y))(e.mA,e.a,e.mI,e.mMA,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixPlusScalar(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixPlusScalar(f(x),f(y))(e.mA,e.a,e.mI,e.mMA,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)    
    case Reflect(e@MatrixPlusWithConvert(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixPlusWithConvert(f(x),f(y))(e.mA,e.mB,e.a,e.mI,e.mMB,e.conv,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixPlusScalarWithConvert(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixPlusScalarWithConvert(f(x),f(y))(e.mA,e.mB,e.a,e.mI,e.mMB,e.conv,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixMinus(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixMinus(f(x),f(y))(e.mA,e.a,e.mI,e.mMA,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixMinusScalar(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixMinusScalar(f(x),f(y))(e.mA,e.a,e.mI,e.mMA,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)    
    case Reflect(e@MatrixMinusWithConvert(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixMinusWithConvert(f(x),f(y))(e.mA,e.mB,e.a,e.mI,e.mMB,e.conv,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixMinusScalarWithConvert(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixMinusScalarWithConvert(f(x),f(y))(e.mA,e.mB,e.a,e.mI,e.mMB,e.conv,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixTimes(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixTimes(f(x),f(y))(e.mA,e.a,e.mI,e.mMA,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixTimesScalar(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixTimesScalar(f(x),f(y))(e.mA,e.a,e.mI,e.mMA,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)    
    case Reflect(e@MatrixTimesWithConvert(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixTimesWithConvert(f(x),f(y))(e.mA,e.mB,e.a,e.mI,e.mMB,e.conv,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixTimesScalarWithConvert(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixTimesScalarWithConvert(f(x),f(y))(e.mA,e.mB,e.a,e.mI,e.mMB,e.conv,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixDivide(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixDivide(f(x),f(y))(e.mA,e.a,e.mI,e.mMA,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixDivideScalar(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixDivideScalar(f(x),f(y))(e.mA,e.a,e.mI,e.mMA,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)    
    case Reflect(e@MatrixDivideWithConvert(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixDivideWithConvert(f(x),f(y))(e.mA,e.mB,e.a,e.mI,e.mMB,e.conv,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixDivideScalarWithConvert(x,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixDivideScalarWithConvert(f(x),f(y))(e.mA,e.mB,e.a,e.mI,e.mMB,e.conv,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixSum(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixSum(f(x))(e.mA,e.a), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixSumRow(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixSumRow(f(x))(e.mA,e.a,e.mVA,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixAbs(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixAbs(f(x))(e.mA,e.a,e.mI,e.mMA,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixExp(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixExp(f(x))(e.mA,e.a,e.mI,e.mMA,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixMin(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixMin(f(x))(e.mA,e.o,e.p), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixMax(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixMax(f(x))(e.mA,e.o,e.p), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixMap(x,g), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixMap(f(x),f(g))(e.mA,e.mB,e.mI,e.mMB,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixMapRows(x,g,out), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixMapRows(f(x),f(g),f(out))(e.mA,e.mB), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)    
    case Reflect(e@MatrixMapRowsSequential(x,g), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixMapRowsSequential(f(x),f(g))(e.mA,e.mB,e.mI,e.mR,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)    
    case Reflect(e@MatrixMapRowsToVec(x,g,r), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixMapRowsToVec(f(x),f(g),f(r))(e.mA,e.mB,e.mVB,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixZipWith(x,y,g), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixZipWith(f(x),f(y),f(g))(e.mA,e.mB,e.mR,e.mI,e.mMR,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)    
    case Reflect(e@MatrixForeach(x,g), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixForeach(f(x),f(g))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)    
    case Reflect(e@MatrixForeachRow(x,g), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixForeachRow(f(x),f(g))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)    
    case Reflect(e@MatrixReduceRows(x,g), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixReduceRows(f(x),f(g))(e.mA,e.mR,e.b), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixCount(x,g), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixCount(f(x),f(g))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixUpdateRow(x,r,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixUpdateRow(f(x),f(r),f(y))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixMutableMap(x,g), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixMutableMap(f(x),f(g))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@MatrixPPrint(x), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with MatrixPPrint(f(x))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
