...
//    extends DeliteOpSingleTask(reifyEffectsHere(sparsematrix_buildable_updaterow_impl(x,row,y)))
  ...
  override def mirror[A:Manifest](e: Def[A], f: Transformer)(implicit ctx: SourceContext): Exp[A] = (e match {
    ...
    // reflected
    case Reflect(e@SparseMatrixBuildableNumRows(x), u, es) => reflectMirrored(Reflect(SparseMatrixBuildableNumRows(f(x))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@SparseMatrixBuildableNumCols(x), u, es) => reflectMirrored(Reflect(SparseMatrixBuildableNumCols(f(x))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)   
    case Reflect(e@SparseMatrixBuildableNNZ(x), u, es) => reflectMirrored(Reflect(SparseMatrixBuildableNNZ(f(x))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)   
    case Reflect(e@SparseMatrixBuildableSetNumRows(x,v), u, es) => reflectMirrored(Reflect(SparseMatrixBuildableSetNumRows(f(x),f(v))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@SparseMatrixBuildableSetNumCols(x,v), u, es) => reflectMirrored(Reflect(SparseMatrixBuildableSetNumCols(f(x),f(v))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)  
    case Reflect(e@SparseMatrixBuildableSetNNZ(x,v), u, es) => reflectMirrored(Reflect(SparseMatrixBuildableSetNNZ(f(x),f(v))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)  
    case Reflect(e@SparseMatrixBuildableApply(x,i,j), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with SparseMatrixBuildableApply(f(x),f(i),f(j))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)      
    case Reflect(e@SparseMatrixBuildableUpdate(x,i,j,r), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with SparseMatrixBuildableUpdate(f(x),f(i),f(j),f(r))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@SparseMatrixBuildableAppend(x,i,j,r), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with SparseMatrixBuildableAppend(f(x),f(i),f(j),f(r))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@SparseMatrixBuildableInsertRow(x,pos,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with SparseMatrixBuildableInsertRow(f(x),f(pos),f(y))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)              
    case Reflect(e@SparseMatrixBuildableInsertAllRows(x,pos,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with SparseMatrixBuildableInsertAllRows(f(x),f(pos),f(y))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)                  
    case Reflect(e@SparseMatrixBuildableInsertCol(x,pos,y), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with SparseMatrixBuildableInsertCol(f(x),f(pos),f(y))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)                
    case Reflect(e@SparseMatrixBuildableInsertAllCols(x,y,z), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with SparseMatrixBuildableInsertAllCols(f(x),f(y),f(z))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)    
    case Reflect(e@SparseMatrixBuildableRemoveRows(x,y,z), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with SparseMatrixBuildableRemoveRows(f(x),f(y),f(z))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)
    case Reflect(e@SparseMatrixBuildableRemoveCols(x,y,z), u, es) => reflectMirrored(Reflect(new { override val original = Some(f,e) } with SparseMatrixBuildableRemoveCols(f(x),f(y),f(z))(e.mA), mapOver(f,u), f(es)))(mtype(manifest[A]), ctx)    
