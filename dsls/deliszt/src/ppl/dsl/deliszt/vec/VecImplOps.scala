...
trait VecImplOps { this: DeLiszt =>
  def vector_concatenate_impl[VT:Manifest](v1: Rep[Vector[VT]], v2: Rep[Vector[VT]]): Rep[Vector[VT]]
}

trait VecImplOpsStandard extends VecImplOps {
  this: DeLisztCompiler with DeLisztLift =>

  def vector_concatenate_impl[VT:Manifest](v1: Rep[Vector[VT]], v2: Rep[Vector[VT]]) = {
