...
private:
	virtual unsigned int run(size_t nN, size_t * sz, size_t * eg, size_t * color_out)=0;
};

class OneColoring : public ColoringAlgorithm {
public:
...
class RegisterColoring : public ColoringAlgorithm {
