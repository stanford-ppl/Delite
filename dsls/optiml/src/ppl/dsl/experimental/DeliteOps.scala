...
trait SandboxScalaGenDeliteOps extends ScalaGenLoopsFat with SandboxBaseGenDeliteOps {
  import IR._
...
trait SandboxCudaGenDeliteOps extends CudaGenLoopsFat with SandboxBaseGenDeliteOps {
  import IR._
...
trait SandboxCGenDeliteOps extends CGenEffect with SandboxBaseGenDeliteOps {
  import IR._
