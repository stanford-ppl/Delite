...
import scala.virtualization.lms.ppl.DSLOpsExp
...
trait MLInputReaderOpsRepExp extends MLInputReaderOps with BaseExp with MLInputReaderImplOps with DSLOpsExp {
