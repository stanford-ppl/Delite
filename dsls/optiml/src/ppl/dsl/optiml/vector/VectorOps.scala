...
//    extends DeliteOpSingleTask(reifyEffectsHere(vector_find_impl[A](x, pred)))
  ...
  override def mirror[A:Manifest](e: Def[A], f: Transformer): Exp[A] = (e match {
    ...
    case e@VectorPlus(x,y) => reflectPure(new VectorPlus(f(x),f(y))(e.m, e.a) { override val transform = f })
    case e@VectorMinus(x,y) => reflectPure(new VectorMinus(f(x),f(y))(e.m, e.a) { override val transform = f })  
    case e@VectorTimes(x,y) => reflectPure(new VectorTimes(f(x),f(y))(e.m, e.a) { override val transform = f })
    case e@VectorTimesScalar(x,y) => reflectPure(new VectorTimesScalar(f(x),f(y))(e.m, e.a) { override val transform = f })
    case e@VectorSum(x) => reflectPure(new VectorSum(f(x))(e.m, e.a) { override val transform = f })
    case e@VectorAbs(x) => reflectPure(new VectorAbs(f(x))(e.m, e.a) { override val transform = f })
    case e@VectorExp(x) => reflectPure(new VectorExp(f(x))(e.m, e.a) { override val transform = f })
    case e@VectorFilter(x,p) => reflectPure(new VectorFilter(f(x),p)(e.m) { override val transform = f })
    case e@VectorFind(x,p) => reflectPure(new VectorFind(f(x),p)(e.m) { override val transform = f })
    case e@VectorCount(x,p) => reflectPure(new VectorCount(f(x),p)(e.m) { override val transform = f })
