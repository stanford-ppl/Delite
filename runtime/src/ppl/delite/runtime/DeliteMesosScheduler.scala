...
object DeliteMesosScheduler {
  ...
  def main(args: Array[String]) {
    ...
    val executorCmd = Config.deliteHome + sep + "bin" + sep + "delite --isSlave -d " + System.getProperty("user.dir") + " -t " + Config.numThreads + " --cuda " + Config.numCuda + " --codecache " + Config.deliteHome+"/generatedCacheSlave " + appArgs.mkString(" ")
    println(executorCmd) 
