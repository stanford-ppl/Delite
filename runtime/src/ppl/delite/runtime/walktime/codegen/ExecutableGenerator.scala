package ppl.delite.runtime.walktime.codegen

import java.util.{ArrayList, ArrayDeque}
import ppl.delite.runtime.walktime.graph.ops.DeliteOP
...
object ExecutableGenerator {
  ...
  private def writeHeader(out: StringBuilder, location: Int) {
    out.append("import ppl.delite.runtime.walktime.codegen.DeliteExecutable\n") //base trait
