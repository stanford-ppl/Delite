...
class OP_Map(val id: String, func: String, private[graph] val outputTypesMap: Map[Targets.Value,Map[String,String]]) extends OP_Executable {
  ...
  def chunk(i: Int): OP_Map = {
    val r = new OP_Map(id+"_"+i, function, Targets.unitTypes(id+"_"+i, outputTypesMap)) //chunks all return Unit
