...
*/
  ...
  def testGDA = testApp("gda", ppl.apps.ml.gda.GDA, Array(datadir+"/ml/gda/q1x.dat",datadir+"/ml/gda/q1y.dat"))
  ...
  def testNaiveBayes = testApp("nb", ppl.apps.ml.nb.NaiveBayes, Array(datadir+"/ml/nb/MATRIX.TRAIN.25k",datadir+"/ml/nb/MATRIX.TEST"))

  def testRBM = testApp("rbm", ppl.apps.ml.rbm.RBM, Array(datadir+"/ml/rbm/mnist2000x10.dat","2000","2000"))
